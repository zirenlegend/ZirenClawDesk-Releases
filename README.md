...
This repository contains official release builds of **ZirenClaw **- a multi-model, multi-channel AI desktop workbench based on [OpenClaw](https://github.com/zirenlegend/openclaw).
...
| ---------------------- | ------------ | ----------------------------------- |
| AppImage (Recommended) | x64          | `ZirenClaw-*-linux-x86_64.AppImage` |
